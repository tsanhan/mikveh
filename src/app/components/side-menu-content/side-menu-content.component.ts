...
import { IonIcon, IonSegment, IonSegmentButton, IonButton, IonFab, IonFabButton, IonImg } from "@ionic/angular/standalone";
...
@Component({
  ...
  standalone: true,
  imports: [IonImg, IonFabButton, IonFab, IonButton, IonSegmentButton, IonSegment, IonIcon,NgIcon ],
...
export class SideMenuContentComponent  implements OnInit {
  ...
  constructor() {
    addIcons({timeOutline,searchOutline});
