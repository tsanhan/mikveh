...
import { IonSearchbar, IonList, IonItem, IonAvatar, IonLabel, IonInfiniteScroll, IonInfiniteScrollContent, InfiniteScrollCustomEvent} from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, IonInfiniteScrollContent, IonInfiniteScroll, IonLabel, IonAvatar, IonItem, IonList, IonSearchbar, AsyncPipe, JsonPipe]
})
